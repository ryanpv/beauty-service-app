    ...
    <>
      <div className='container flex'>
        ...
        { typeof currentUser !== 'string' && currentUser.id !== 0 && currentUser.role !== 0 ? <span>already logged in </span> : null }
          <div className='shadow-xl space-y-10 shadow-gray-300 overflow-hidden rounded-sm border border-gray-100 mt-10 p-16 sm:mx-auto sm:w-full sm:max-w-lg sm:min-h-80 font-medium'>
